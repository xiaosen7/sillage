import { R as a } from "./index-53175ba2.js";
function f(e, h) {
  if (e == null) return {};
  var n = {},
    c = Object.keys(e),
...
var s = { small: 16, medium: 32, large: 64 };
function t(e, h, n) {
  var c = n(),
    l = Object.keys(c);
  function o(r) {
    var m = r["aria-label"],
      ...
      V = d === void 0 ? h : d,
      p = r.fill,
      w = p === void 0 ? "currentColor" : p,
      M = r.size,
      A = M === void 0 ? 16 : M,
      u = r.verticalAlign,
      I = u === void 0 ? "text-bottom" : u,
      Z = s[A] || A,
      i = g(l, Z),
      E = c[i].width,
      H = Z * (E / i),
...
var F = t("AccessibilityIcon", "octicon octicon-accessibility", function () {
    return {
      16: {
        width: 16,
  ...
  S = t("AlertIcon", "octicon octicon-alert", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  b = t("AlertFillIcon", "octicon octicon-alert-fill", function () {
    return {
      12: {
        width: 12,
        path: a.createElement("path", {
  ...
  y = t("AppsIcon", "octicon octicon-apps", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  D = t("ArchiveIcon", "octicon octicon-archive", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  R = t("ArrowBothIcon", "octicon octicon-arrow-both", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  P = t("ArrowDownIcon", "octicon octicon-arrow-down", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  T = t("ArrowDownLeftIcon", "octicon octicon-arrow-down-left", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  B = t("ArrowDownRightIcon", "octicon octicon-arrow-down-right", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  G = t("ArrowLeftIcon", "octicon octicon-arrow-left", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  O = t("ArrowRightIcon", "octicon octicon-arrow-right", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  U = t("ArrowSwitchIcon", "octicon octicon-arrow-switch", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  x = t("ArrowUpIcon", "octicon octicon-arrow-up", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  q = t("ArrowUpLeftIcon", "octicon octicon-arrow-up-left", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  j = t("ArrowUpRightIcon", "octicon octicon-arrow-up-right", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  z = t("BeakerIcon", "octicon octicon-beaker", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  N = t("BellIcon", "octicon octicon-bell", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  W = t("BellFillIcon", "octicon octicon-bell-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  X = t("BellSlashIcon", "octicon octicon-bell-slash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  K = t("BlockedIcon", "octicon octicon-blocked", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Q = t("BoldIcon", "octicon octicon-bold", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  _ = t("BookIcon", "octicon octicon-book", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  $ = t("BookmarkIcon", "octicon octicon-bookmark", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  J = t("BookmarkFillIcon", "octicon octicon-bookmark-fill", function () {
    return {
      24: {
        width: 24,
        path: a.createElement("path", {
  ...
  Y = t("BookmarkSlashIcon", "octicon octicon-bookmark-slash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  t1 = t("BriefcaseIcon", "octicon octicon-briefcase", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  e1 = t("BroadcastIcon", "octicon octicon-broadcast", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  c1 = t("BrowserIcon", "octicon octicon-browser", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  n1 = t("BugIcon", "octicon octicon-bug", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  h1 = t("CacheIcon", "octicon octicon-cache", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  l1 = t("CalendarIcon", "octicon octicon-calendar", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  o1 = t("CheckIcon", "octicon octicon-check", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  r1 = t("CheckCircleIcon", "octicon octicon-check-circle", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Z1 = t("CheckboxIcon", "octicon octicon-checkbox", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  m1 = t("ChecklistIcon", "octicon octicon-checklist", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  v1 = t("ChevronDownIcon", "octicon octicon-chevron-down", function () {
    return {
      12: {
        width: 12,
        path: a.createElement("path", {
  ...
  d1 = t("ChevronLeftIcon", "octicon octicon-chevron-left", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  p1 = t("ChevronRightIcon", "octicon octicon-chevron-right", function () {
    return {
      12: {
        width: 12,
        path: a.createElement("path", {
  ...
  M1 = t("ChevronUpIcon", "octicon octicon-chevron-up", function () {
    return {
      12: {
        width: 12,
        path: a.createElement("path", {
  ...
  A1 = t("CircleIcon", "octicon octicon-circle", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  u1 = t("CircleSlashIcon", "octicon octicon-circle-slash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  E1 = t("ClockIcon", "octicon octicon-clock", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  V1 = t("ClockFillIcon", "octicon octicon-clock-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  w1 = t("CloudIcon", "octicon octicon-cloud", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  I1 = t("CloudOfflineIcon", "octicon octicon-cloud-offline", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  H1 = t("CodeIcon", "octicon octicon-code", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  L1 = t("CodeOfConductIcon", "octicon octicon-code-of-conduct", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  f1 = t("CodeReviewIcon", "octicon octicon-code-review", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  C1 = t("CodeSquareIcon", "octicon octicon-code-square", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  s1 = t("CodescanIcon", "octicon octicon-codescan", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  F1 = t("CodespacesIcon", "octicon octicon-codespaces", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  k1 = t("ColumnsIcon", "octicon octicon-columns", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  S1 = t("CommandPaletteIcon", "octicon octicon-command-palette", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  b1 = t("CommentIcon", "octicon octicon-comment", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  D1 = t("CommitIcon", "octicon octicon-commit", function () {
    return {
      24: {
        width: 24,
        path: a.createElement(
  ...
  R1 = t("ContainerIcon", "octicon octicon-container", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  P1 = t("CopilotIcon", "octicon octicon-copilot", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  T1 = t("CopilotErrorIcon", "octicon octicon-copilot-error", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  B1 = t("CopilotWarningIcon", "octicon octicon-copilot-warning", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  G1 = t("CopyIcon", "octicon octicon-copy", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  O1 = t("CpuIcon", "octicon octicon-cpu", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  U1 = t("CreditCardIcon", "octicon octicon-credit-card", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  x1 = t("CrossReferenceIcon", "octicon octicon-cross-reference", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  q1 = t("DashIcon", "octicon octicon-dash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  j1 = t("DatabaseIcon", "octicon octicon-database", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  z1 = t("DependabotIcon", "octicon octicon-dependabot", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  W1 = t("DeviceCameraIcon", "octicon octicon-device-camera", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  K1 = t("DeviceDesktopIcon", "octicon octicon-device-desktop", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Q1 = t("DeviceMobileIcon", "octicon octicon-device-mobile", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  _1 = t("DiamondIcon", "octicon octicon-diamond", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  $1 = t("DiffIcon", "octicon octicon-diff", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  J1 = t("DiffAddedIcon", "octicon octicon-diff-added", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Y1 = t("DiffIgnoredIcon", "octicon octicon-diff-ignored", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  a5 = t("DiffModifiedIcon", "octicon octicon-diff-modified", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  t5 = t("DiffRemovedIcon", "octicon octicon-diff-removed", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  e5 = t("DiffRenamedIcon", "octicon octicon-diff-renamed", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  c5 = t("DotIcon", "octicon octicon-dot", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  n5 = t("DotFillIcon", "octicon octicon-dot-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  h5 = t("DownloadIcon", "octicon octicon-download", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  l5 = t("DuplicateIcon", "octicon octicon-duplicate", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  o5 = t("EllipsisIcon", "octicon octicon-ellipsis", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  r5 = t("EyeIcon", "octicon octicon-eye", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  i5 = t("EyeClosedIcon", "octicon octicon-eye-closed", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Z5 = t("FeedDiscussionIcon", "octicon octicon-feed-discussion", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  m5 = t("FeedForkedIcon", "octicon octicon-feed-forked", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  v5 = t("FeedHeartIcon", "octicon octicon-feed-heart", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  d5 = t("FeedMergedIcon", "octicon octicon-feed-merged", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  p5 = t("FeedPersonIcon", "octicon octicon-feed-person", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  M5 = t("FeedRepoIcon", "octicon octicon-feed-repo", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  A5 = t("FeedRocketIcon", "octicon octicon-feed-rocket", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  u5 = t("FeedStarIcon", "octicon octicon-feed-star", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  E5 = t("FeedTagIcon", "octicon octicon-feed-tag", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  V5 = t("FeedTrophyIcon", "octicon octicon-feed-trophy", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  w5 = t("FileIcon", "octicon octicon-file", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  I5 = t("FileAddedIcon", "octicon octicon-file-added", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  H5 = t("FileBadgeIcon", "octicon octicon-file-badge", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  L5 = t("FileBinaryIcon", "octicon octicon-file-binary", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  f5 = t("FileCodeIcon", "octicon octicon-file-code", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  C5 = t("FileDiffIcon", "octicon octicon-file-diff", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  s5 = t("FileDirectoryIcon", "octicon octicon-file-directory", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  k5 = t("FileMediaIcon", "octicon octicon-file-media", function () {
    return {
      24: {
        width: 24,
        path: a.createElement("path", {
  ...
  S5 = t("FileMovedIcon", "octicon octicon-file-moved", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  b5 = t("FileRemovedIcon", "octicon octicon-file-removed", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  y5 = t("FileSubmoduleIcon", "octicon octicon-file-submodule", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  R5 = t("FileZipIcon", "octicon octicon-file-zip", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  P5 = t("FilterIcon", "octicon octicon-filter", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  T5 = t("FiscalHostIcon", "octicon octicon-fiscal-host", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  B5 = t("FlameIcon", "octicon octicon-flame", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  G5 = t("FoldIcon", "octicon octicon-fold", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  O5 = t("FoldDownIcon", "octicon octicon-fold-down", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  U5 = t("FoldUpIcon", "octicon octicon-fold-up", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  x5 = t("GearIcon", "octicon octicon-gear", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  q5 = t("GiftIcon", "octicon octicon-gift", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  j5 = t("GitBranchIcon", "octicon octicon-git-branch", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  z5 = t("GitCommitIcon", "octicon octicon-git-commit", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  N5 = t("GitCompareIcon", "octicon octicon-git-compare", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  W5 = t("GitMergeIcon", "octicon octicon-git-merge", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  X5 = t("GitMergeQueueIcon", "octicon octicon-git-merge-queue", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  K5 = t("GitPullRequestIcon", "octicon octicon-git-pull-request", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  $5 = t("GlobeIcon", "octicon octicon-globe", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  J5 = t("GoalIcon", "octicon octicon-goal", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  Y5 = t("GrabberIcon", "octicon octicon-grabber", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  a0 = t("GraphIcon", "octicon octicon-graph", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  t0 = t("HashIcon", "octicon octicon-hash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  e0 = t("HeadingIcon", "octicon octicon-heading", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  c0 = t("HeartIcon", "octicon octicon-heart", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  n0 = t("HeartFillIcon", "octicon octicon-heart-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  h0 = t("HistoryIcon", "octicon octicon-history", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  l0 = t("HomeIcon", "octicon octicon-home", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  o0 = t("HomeFillIcon", "octicon octicon-home-fill", function () {
    return {
      24: {
        width: 24,
        path: a.createElement("path", {
  ...
  r0 = t("HorizontalRuleIcon", "octicon octicon-horizontal-rule", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  i0 = t("HourglassIcon", "octicon octicon-hourglass", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Z0 = t("HubotIcon", "octicon octicon-hubot", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  m0 = t("IdBadgeIcon", "octicon octicon-id-badge", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  v0 = t("ImageIcon", "octicon octicon-image", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  d0 = t("InboxIcon", "octicon octicon-inbox", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  p0 = t("InfinityIcon", "octicon octicon-infinity", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  M0 = t("InfoIcon", "octicon octicon-info", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  A0 = t("IssueClosedIcon", "octicon octicon-issue-closed", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  u0 = t("IssueDraftIcon", "octicon octicon-issue-draft", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  E0 = t("IssueOpenedIcon", "octicon octicon-issue-opened", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  V0 = t("IssueReopenedIcon", "octicon octicon-issue-reopened", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  w0 = t("IssueTrackedByIcon", "octicon octicon-issue-tracked-by", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  I0 = t("IssueTracksIcon", "octicon octicon-issue-tracks", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  H0 = t("ItalicIcon", "octicon octicon-italic", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  L0 = t("IterationsIcon", "octicon octicon-iterations", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  C0 = t("KeyIcon", "octicon octicon-key", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  s0 = t("KeyAsteriskIcon", "octicon octicon-key-asterisk", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  g0 = t("LawIcon", "octicon octicon-law", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  F0 = t("LightBulbIcon", "octicon octicon-light-bulb", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  k0 = t("LinkIcon", "octicon octicon-link", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  S0 = t("LinkExternalIcon", "octicon octicon-link-external", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  b0 = t("ListOrderedIcon", "octicon octicon-list-ordered", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  y0 = t("ListUnorderedIcon", "octicon octicon-list-unordered", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  D0 = t("LocationIcon", "octicon octicon-location", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  R0 = t("LockIcon", "octicon octicon-lock", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  P0 = t("LogIcon", "octicon octicon-log", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  T0 = t("LogoGistIcon", "octicon octicon-logo-gist", function () {
    return {
      16: {
        width: 25,
        path: a.createElement("path", {
  ...
  B0 = t("LogoGithubIcon", "octicon octicon-logo-github", function () {
    return {
      16: {
        width: 45,
        path: a.createElement("path", {
  ...
  G0 = t("MailIcon", "octicon octicon-mail", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  O0 = t("MarkGithubIcon", "octicon octicon-mark-github", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  U0 = t("MarkdownIcon", "octicon octicon-markdown", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  x0 = t("MegaphoneIcon", "octicon octicon-megaphone", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  q0 = t("MentionIcon", "octicon octicon-mention", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  j0 = t("MeterIcon", "octicon octicon-meter", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  z0 = t("MilestoneIcon", "octicon octicon-milestone", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  N0 = t("MirrorIcon", "octicon octicon-mirror", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  W0 = t("MoonIcon", "octicon octicon-moon", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  X0 = t("MortarBoardIcon", "octicon octicon-mortar-board", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  K0 = t("MoveToBottomIcon", "octicon octicon-move-to-bottom", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Q0 = t("MoveToEndIcon", "octicon octicon-move-to-end", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  _0 = t("MoveToStartIcon", "octicon octicon-move-to-start", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  $0 = t("MoveToTopIcon", "octicon octicon-move-to-top", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  J0 = t("MultiSelectIcon", "octicon octicon-multi-select", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Y0 = t("MuteIcon", "octicon octicon-mute", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  a2 = t("NoEntryIcon", "octicon octicon-no-entry", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  t2 = t("NoEntryFillIcon", "octicon octicon-no-entry-fill", function () {
    return {
      12: {
        width: 12,
        path: a.createElement("path", {
  ...
  e2 = t("NorthStarIcon", "octicon octicon-north-star", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  c2 = t("NoteIcon", "octicon octicon-note", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  n2 = t("NumberIcon", "octicon octicon-number", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  h2 = t("OrganizationIcon", "octicon octicon-organization", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  l2 = t("PackageIcon", "octicon octicon-package", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  i2 = t("PaintbrushIcon", "octicon octicon-paintbrush", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Z2 = t("PaperAirplaneIcon", "octicon octicon-paper-airplane", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  m2 = t("PaperclipIcon", "octicon octicon-paperclip", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  v2 = t("PasteIcon", "octicon octicon-paste", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  d2 = t("PencilIcon", "octicon octicon-pencil", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  p2 = t("PeopleIcon", "octicon octicon-people", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  M2 = t("PersonIcon", "octicon octicon-person", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  A2 = t("PersonAddIcon", "octicon octicon-person-add", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  u2 = t("PersonFillIcon", "octicon octicon-person-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  E2 = t("PinIcon", "octicon octicon-pin", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  V2 = t("PlayIcon", "octicon octicon-play", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  w2 = t("PlugIcon", "octicon octicon-plug", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  I2 = t("PlusIcon", "octicon octicon-plus", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  H2 = t("PlusCircleIcon", "octicon octicon-plus-circle", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  L2 = t("ProjectIcon", "octicon octicon-project", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  f2 = t("ProjectRoadmapIcon", "octicon octicon-project-roadmap", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  C2 = t("ProjectSymlinkIcon", "octicon octicon-project-symlink", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  s2 = t("PulseIcon", "octicon octicon-pulse", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  g2 = t("QuestionIcon", "octicon octicon-question", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  F2 = t("QuoteIcon", "octicon octicon-quote", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  k2 = t("ReadIcon", "octicon octicon-read", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  S2 = t("RelFilePathIcon", "octicon octicon-rel-file-path", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  b2 = t("ReplyIcon", "octicon octicon-reply", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  y2 = t("RepoIcon", "octicon octicon-repo", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  D2 = t("RepoCloneIcon", "octicon octicon-repo-clone", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  R2 = t("RepoDeletedIcon", "octicon octicon-repo-deleted", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  P2 = t("RepoForkedIcon", "octicon octicon-repo-forked", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  T2 = t("RepoLockedIcon", "octicon octicon-repo-locked", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  B2 = t("RepoPullIcon", "octicon octicon-repo-pull", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  G2 = t("RepoPushIcon", "octicon octicon-repo-push", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  O2 = t("RepoTemplateIcon", "octicon octicon-repo-template", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  U2 = t("ReportIcon", "octicon octicon-report", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  x2 = t("RocketIcon", "octicon octicon-rocket", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  q2 = t("RowsIcon", "octicon octicon-rows", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  j2 = t("RssIcon", "octicon octicon-rss", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  z2 = t("RubyIcon", "octicon octicon-ruby", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  N2 = t("ScreenFullIcon", "octicon octicon-screen-full", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  W2 = t("ScreenNormalIcon", "octicon octicon-screen-normal", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  X2 = t("SearchIcon", "octicon octicon-search", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  K2 = t("ServerIcon", "octicon octicon-server", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Q2 = t("ShareIcon", "octicon octicon-share", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  _2 = t("ShareAndroidIcon", "octicon octicon-share-android", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  $2 = t("ShieldIcon", "octicon octicon-shield", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  J2 = t("ShieldCheckIcon", "octicon octicon-shield-check", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Y2 = t("ShieldLockIcon", "octicon octicon-shield-lock", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  a7 = t("ShieldSlashIcon", "octicon octicon-shield-slash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  t7 = t("ShieldXIcon", "octicon octicon-shield-x", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  c7 = t("SidebarExpandIcon", "octicon octicon-sidebar-expand", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  n7 = t("SignInIcon", "octicon octicon-sign-in", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  h7 = t("SignOutIcon", "octicon octicon-sign-out", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  l7 = t("SingleSelectIcon", "octicon octicon-single-select", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  o7 = t("SkipIcon", "octicon octicon-skip", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  r7 = t("SkipFillIcon", "octicon octicon-skip-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  i7 = t("SlidersIcon", "octicon octicon-sliders", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Z7 = t("SmileyIcon", "octicon octicon-smiley", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  m7 = t("SortAscIcon", "octicon octicon-sort-asc", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  v7 = t("SortDescIcon", "octicon octicon-sort-desc", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  d7 = t("SparkleFillIcon", "octicon octicon-sparkle-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  p7 = t("SponsorTiersIcon", "octicon octicon-sponsor-tiers", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  M7 = t("SquareIcon", "octicon octicon-square", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  A7 = t("SquareFillIcon", "octicon octicon-square-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  u7 = t("SquirrelIcon", "octicon octicon-squirrel", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  E7 = t("StackIcon", "octicon octicon-stack", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  V7 = t("StarIcon", "octicon octicon-star", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  w7 = t("StarFillIcon", "octicon octicon-star-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  I7 = t("StopIcon", "octicon octicon-stop", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  H7 = t("StopwatchIcon", "octicon octicon-stopwatch", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  L7 = t("StrikethroughIcon", "octicon octicon-strikethrough", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  f7 = t("SunIcon", "octicon octicon-sun", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  C7 = t("SyncIcon", "octicon octicon-sync", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  s7 = t("TabIcon", "octicon octicon-tab", function () {
    return {
      24: {
        width: 24,
        path: a.createElement("path", {
  ...
  g7 = t("TabExternalIcon", "octicon octicon-tab-external", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  F7 = t("TableIcon", "octicon octicon-table", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  k7 = t("TagIcon", "octicon octicon-tag", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  S7 = t("TasklistIcon", "octicon octicon-tasklist", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  b7 = t("TelescopeIcon", "octicon octicon-telescope", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  y7 = t("TelescopeFillIcon", "octicon octicon-telescope-fill", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  D7 = t("TerminalIcon", "octicon octicon-terminal", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  R7 = t("ThreeBarsIcon", "octicon octicon-three-bars", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  P7 = t("ThumbsdownIcon", "octicon octicon-thumbsdown", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  T7 = t("ThumbsupIcon", "octicon octicon-thumbsup", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  B7 = t("ToolsIcon", "octicon octicon-tools", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  G7 = t("TrashIcon", "octicon octicon-trash", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  O7 = t("TriangleDownIcon", "octicon octicon-triangle-down", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  U7 = t("TriangleLeftIcon", "octicon octicon-triangle-left", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  x7 = t("TriangleRightIcon", "octicon octicon-triangle-right", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  q7 = t("TriangleUpIcon", "octicon octicon-triangle-up", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  j7 = t("TrophyIcon", "octicon octicon-trophy", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  z7 = t("TypographyIcon", "octicon octicon-typography", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  N7 = t("UnfoldIcon", "octicon octicon-unfold", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  W7 = t("UnlinkIcon", "octicon octicon-unlink", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  X7 = t("UnlockIcon", "octicon octicon-unlock", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  K7 = t("UnmuteIcon", "octicon octicon-unmute", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Q7 = t("UnreadIcon", "octicon octicon-unread", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  _7 = t("UnverifiedIcon", "octicon octicon-unverified", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  $7 = t("UploadIcon", "octicon octicon-upload", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  J7 = t("VerifiedIcon", "octicon octicon-verified", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  Y7 = t("VersionsIcon", "octicon octicon-versions", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  a4 = t("VideoIcon", "octicon octicon-video", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  t4 = t("WebhookIcon", "octicon octicon-webhook", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  e4 = t("WorkflowIcon", "octicon octicon-workflow", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  c4 = t("XIcon", "octicon octicon-x", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  n4 = t("XCircleIcon", "octicon octicon-x-circle", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  h4 = t("XCircleFillIcon", "octicon octicon-x-circle-fill", function () {
    return {
      12: {
        width: 12,
        path: a.createElement("path", {
  ...
  l4 = t("ZapIcon", "octicon octicon-zap", function () {
    return {
      16: {
        width: 16,
        path: a.createElement("path", {
  ...
  o4 = t("ZoomInIcon", "octicon octicon-zoom-in", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
  ...
  r4 = t("ZoomOutIcon", "octicon octicon-zoom-out", function () {
    return {
      16: {
        width: 16,
        path: a.createElement(
...
function Z4(e) {
  ...
  return (
    ...
    typeof h == "function"
      ? a.createElement(h, c)
      : a.cloneElement(a.Children.only(n), c)
  );
}
  ...
  Object.defineProperty(
    {
      ...
      CloudOfflineIcon: I1,
      CodeIcon: H1,
      CodeOfConductIcon: L1,
      CodeReviewIcon: f1,
      CodeSquareIcon: C1,
      CodescanCheckmarkIcon: g1,
      CodescanIcon: s1,
      CodespacesIcon: F1,
      ColumnsIcon: k1,
      CommandPaletteIcon: S1,
      CommentDiscussionIcon: y1,
      CommentIcon: b1,
      CommitIcon: D1,
      ContainerIcon: R1,
      CopilotErrorIcon: T1,
      CopilotIcon: P1,
      CopilotWarningIcon: B1,
      CopyIcon: G1,
      CpuIcon: O1,
      CreditCardIcon: U1,
      CrossReferenceIcon: x1,
      DashIcon: q1,
      DatabaseIcon: j1,
      DependabotIcon: z1,
      DesktopDownloadIcon: N1,
      DeviceCameraIcon: W1,
      DeviceCameraVideoIcon: X1,
      DeviceDesktopIcon: K1,
      DeviceMobileIcon: Q1,
      DiamondIcon: _1,
      DiffAddedIcon: J1,
      DiffIcon: $1,
      ...
      FileCodeIcon: f5,
      FileDiffIcon: C5,
      FileDirectoryFillIcon: g5,
      FileDirectoryIcon: s5,
      FileDirectoryOpenFillIcon: F5,
      FileIcon: w5,
      FileMediaIcon: k5,
      FileMovedIcon: S5,
      FileRemovedIcon: b5,
      FileSubmoduleIcon: y5,
      FileSymlinkFileIcon: D5,
      FileZipIcon: R5,
      FilterIcon: P5,
      FiscalHostIcon: T5,
      FlameIcon: B5,
      ...
      GitCompareIcon: N5,
      GitMergeIcon: W5,
      GitMergeQueueIcon: X5,
      GitPullRequestClosedIcon: Q5,
      GitPullRequestDraftIcon: _5,
      GitPullRequestIcon: K5,
      GlobeIcon: $5,
      GoalIcon: J5,
      GrabberIcon: Y5,
      GraphIcon: a0,
      ...
      IssueDraftIcon: u0,
      IssueOpenedIcon: E0,
      IssueReopenedIcon: V0,
      IssueTrackedByIcon: w0,
      IssueTracksIcon: I0,
      ItalicIcon: H0,
      IterationsIcon: L0,
      KebabHorizontalIcon: f0,
      KeyAsteriskIcon: s0,
      KeyIcon: C0,
      LawIcon: g0,
      LightBulbIcon: F0,
      ...
      NumberIcon: n2,
      OrganizationIcon: h2,
      PackageDependenciesIcon: o2,
      PackageDependentsIcon: r2,
      PackageIcon: l2,
      PaintbrushIcon: i2,
      PaperAirplaneIcon: Z2,
      PaperclipIcon: m2,
      PasteIcon: v2,
      PencilIcon: d2,
      PeopleIcon: p2,
      ...
      PlusIcon: I2,
      ProjectIcon: L2,
      ProjectRoadmapIcon: f2,
      ProjectSymlinkIcon: C2,
      PulseIcon: s2,
      QuestionIcon: g2,
      QuoteIcon: F2,
      ReadIcon: k2,
      ...
      ShieldSlashIcon: a7,
      ShieldXIcon: t7,
      SidebarCollapseIcon: e7,
      SidebarExpandIcon: c7,
      SignInIcon: n7,
      SignOutIcon: h7,
      SingleSelectIcon: l7,
      SkipFillIcon: r7,
